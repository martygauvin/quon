...
<?php echo $this->Form->create('SurveyInstanceObject');?>
	<fieldset>
		<legend><?php echo __('Edit Survey Instance Object'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SurveyInstanceObject.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SurveyInstanceObject.id'))); ?></li>
