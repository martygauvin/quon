...
<?php echo $this->Form->create('SurveyResult');?>
	<fieldset>
		<legend><?php echo __('Edit Survey Result'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SurveyResult.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SurveyResult.id'))); ?></li>
